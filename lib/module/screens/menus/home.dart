...
class _HomeScreenState extends State<HomeScreen> {
  List<String> days = ['All', 'Recommended', 'Popular', 'Ratings', 'States'];
  int selectedItem = 0;
                        ...
                        child: Column(
                          ...
                          children: [
                            ClipRRect(
                              borderRadius: BorderRadius.circular(20.0),
                              child: Image.network(
                                'https://www.hotellesdamesdupantheon.com/uploads/images/monuments/hc-a-eu-france-paris-eiffel-tower.jpg',
                                fit: BoxFit.fill,
                                height: 120,
                              ),
                            ),
